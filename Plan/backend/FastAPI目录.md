...
状态：accepted  
搭框架时按 [搭框架/说明.md](搭框架/说明.md) 创建这些目录。第一块如何挂载见 [../architecture/融合.md](../architecture/融合.md)。
...
`core` 配 CORS、engine、Redis。本进程 **只提供 API**。生产不要在这里托管前端静态资源（ADR 0012）。数据层：[数据层.md](数据层.md)。搭框架：[搭框架/说明.md](搭框架/说明.md)。
